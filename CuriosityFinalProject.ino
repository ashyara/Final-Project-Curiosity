...
const char* ssid = "Voyager2";
const char* password = "bimasakti";

// Insert Firebase project API Key
#define API_KEY  "AIzaSyAqOTZ1kW18Wu9I5K5bAWzSqG6g7rJLsDA"

// Insert Authorized Email and Corresponding Password
#define USER_EMAIL  "ashyarahimaa@gmail.com"
#define USER_PASSWORD "Inumakitoge1*"

// Insert Firebase storage bucket ID e.g bucket-name.appspot.com
#define STORAGE_BUCKET_ID "coba-aja-deh-4514e.appspot.com"

// Photo File Name to save in LittleFS
#define FILE_PHOTO_PATH "/photo.jpg"
#define BUCKET_PHOTO "/data/photo.jpg"

#define BUTTON_PIN 12 //GPIO12 pin button
#define LED1 14 //red led
#define LED2 15 //blue led
